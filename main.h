...
int handle_print(const char *fmt, int *counter, va_list argslist, char tempBuffer[],
...
int get_flags(const char *format, int *counter);
int get_width(const char *format, int *counter, va_list list);
int get_precision(const char *format, int *counter, va_list list);
int get_size(const char *format, int *counter);
